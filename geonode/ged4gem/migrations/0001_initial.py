...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ged4gem_gadm_country_facts_00', (
            ...
            ('gadm_country_alias', self.gf('django.db.models.fields.CharField')(null=True, max_length=30)),
    ...
    models = {
        'ged4gem.gadm_country_facts_00': {
            ...
            'gadm_country_alias': ('django.db.models.fields.CharField', [], {'null': 'True', 'max_length': '30'}),
