...
class gadm_country_facts_00(models.Model):
    ...
    gadm_country_name = models.CharField()
    gadm_country_alias = models.CharField(null=True)
    ...
    urban_rural_source = models.CharField()
    ...
    population_src_source = models.CharField()
    population_src_description = models.CharField()
    ...
    mapping_schemes = models.CharField(null=True)
