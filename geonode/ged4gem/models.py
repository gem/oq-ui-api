...
class gadm_country_facts(models.Model):
    ...
    gadm_country_name = models.Varchar()
    gadm_country_alias = models.Varchar()
    gadm_country_iso = models.CharField(max_length=3)
    gadm_country_shape_perimeter = models.PositiveIntegerField()
    gadm_country_shape_area = models.PositiveIntegerField()
    gadm_country_date = models.DateField(null=True, blank=True)
    urban_rural_source = models.Varchar()
    ...
    population_src_source = models.CharField(max_length=None)
    population_src_description = models.Varchar()
    ...
    mapping_schemes = models.Varchar()
    moresimplegeom = models.Point(srid=4326, dim=3)
